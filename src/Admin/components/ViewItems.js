...
import '../../frontend/components/Menu.css';
  ...
  return (
    <div>
      <div className="search-container">
        ...
        <button className='button-primary' id='filter-button' onClick={handleDropdown}>Filters</button>
        <div className='dropdown'>
          ...
          <select name="origin" value={selectedFilters.origin} onChange={handleFilterChange}>
          ...
          <div className="filter-buttons">
            <button className='button-tertiary' onClick={handleApplyFilters} style={{ marginLeft: '0px' }}>Apply Filters</button>
            <button className="button-tertiary" onClick={handleClearFilters}>Clear Filters</button>
            <button className='button-tertiary' onClick={handleClose} style={{ background: 'red' }}><i className="fa-solid fa-xmark"></i></button>
          </div>
        </div>
      </div>
...
const FoodCard = ({ menu }) => {
  return (
    <div className="food-card">
      <img src={menu.photo_url} alt={menu.item_name} />
